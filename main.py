...
# funciones
def Papel():
    messagebox.showinfo("Vas a seleccionar este objeto")
...
Frame_1.config(bg="ivory3", width=780, height=240)
Frame_1.place(x=10, y=10) 


Frame_2 = Frame(ventana_principal)        
Frame_2.config(bg="ivory3", width=780, height=120) 
...
# Logo
logo = PhotoImage(file = "img/db_Postal.png")
